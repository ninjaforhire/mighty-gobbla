...
## Tool
**Script:** `src/scripts/create_proposal.py`
...
3. **Execute Proposal Creation**
   - **Tool:** `src/scripts/create_proposal.py`
   - **Usage:** Save the JSON to a file and run: `python3 src/scripts/create_proposal.py < input.json`
   ...
   - Run the python script:
     ...
     python3 src/scripts/create_proposal.py <<'EOF'
     [JSON_CONTENT]
     EOF
     ```
